                ...
                <table border="0" class="auto-style1">
                    ...
                    <tr>
                        <td class="auto-style3">
                            <br />
                            Project Phase :
                            <asp:CheckBox ID="CheckBox1" runat="server" Text="Warranty" OnCheckedChanged="CheckBox1_CheckedChanged" />
&nbsp;<asp:CheckBox ID="CheckBox2" runat="server" Text="Maintainence" OnCheckedChanged="CheckBox2_CheckedChanged" />
&nbsp;<asp:CheckBox ID="CheckBox3" runat="server" Text="Per Call (No Contract)" />
                    ...
                    <tr>
                        <td class="auto-style3">
                            ...
                            <asp:TextBox ID="TextBox9" runat="server" ReadOnly="True" OnTextChanged="TextBox9_TextChanged"></asp:TextBox>
                            ...
                            <br />
                            Estimated End Date :&nbsp;
                            <asp:TextBox ID="TextBox10" runat="server" ReadOnly="True" OnTextChanged="TextBox10_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td class="auto-style3">
                            <br />
                            <asp:CheckBox ID="CheckBox4" runat="server" Text="Accepted" OnCheckedChanged="CheckBox4_CheckedChanged" />
&nbsp;<asp:CheckBox ID="CheckBox5" runat="server" Text="Withdrawn" />
&nbsp;<asp:CheckBox ID="CheckBox6" runat="server" Text="Keep In View TIll __________" OnCheckedChanged="CheckBox6_CheckedChanged" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style28">
                            <br />
                            Other Comments :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="TextBox12" runat="server" Height="82px" Width="238px" OnTextChanged="TextBox12_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
...
&nbsp;&nbsp;<br />
                            Date :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <asp:TextBox ID="TextBox15" runat="server" OnTextChanged="TextBox15_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td class="auto-style3">
                            ...
                            <br />
                            <br />
                            <asp:TextBox ID="TextBox16" runat="server" BorderColor="#3366FF" Height="160px" TextMode="MultiLine" Width="420px" OnTextChanged="TextBox16_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                   <table border="1" class="auto-style1">
                       ...
                       <tr>
                           ...
                           <td class="auto-style20">
                               <asp:TextBox ID="TextBox39" runat="server" Height="16px" Width="86px" OnTextChanged="TextBox39_TextChanged"></asp:TextBox>
                           </td>
                ...
                <table class="auto-style1">
                    <tr>
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="TextBox48" runat="server" BorderColor="#3366FF" Height="160px" TextMode="MultiLine" Width="420px" OnTextChanged="TextBox48_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style24">Signature :<asp:TextBox ID="TextBox50" runat="server" OnTextChanged="TextBox50_TextChanged"></asp:TextBox>
                        </td>
