...
public partial class BasicControls_wuc_SectionE : System.Web.UI.UserControl
{
    ...
    {
        ; PdfDocument pdf = PdfReader.Open(@"C:\Users\wanhao0703/EIS-ServiceRequest.pdf");
        //PdfDocument pdf = new PdfDocument();
        pdf.Info.Title = "My First PDF";
        PdfPage pdfPage1 = pdf.Pages[0];
        PdfPage pdfPage2 = pdf.Pages[1];
        PdfPage pdfPage3 = pdf.Pages[2];
        PdfPage pdfPage4 = pdf.Pages[3];
        ...
        string pdfFilename = @"C:\Users\wanhao0703\Desktopfirstpage.pdf";
